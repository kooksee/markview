...
func Dir() (string, error) {
	...
	return filepath.Join(stateHome, "markview", "log"), nil
}

// Setup configures slog to write to a rotating log file under XDG_STATE_HOME/markview/log/.
...
func Setup(port int) (func(), error) {
	...
	filename := filepath.Join(dir, fmt.Sprintf("markview-%d.log", port))
